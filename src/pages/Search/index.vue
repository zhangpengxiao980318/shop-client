  ...
  <div>
    ...
    <div class="main">
      <div class="py-container">
        ...
        <!--selector-->
        <SearchSelector :addProps="addProps" @addTrademark="addTrademark"/>
...
export default {
  ...
  computed: {
    ...
    methods:{
      ...
      //设置品牌条件
      addTrademark(value){
        if(value === this.options.trademark) return
        // this.options.trademark = value
        this.$set(this.options,'trademark',value)
